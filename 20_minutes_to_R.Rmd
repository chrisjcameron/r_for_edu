...
```{r}
my_df$gender = "boy"   # single value broadcast to whole column
my_df
my_df$gender[5:9] = "girl" # single value broadcast to subset
my_df
```
...
The summary for gender is disappointing. We should make this a factor, so it is treated as a categorical variable.
